...
# from .utility.auth_required import auth_required
#
#
...
#         limit = page_size
#         examples = request.env['mataa.base.example'].sudo().search([], limit=limit, offset=offset)
#         total_count = request.env['mataa.base.example'].sudo().search_count([])
...
#         example = request.env['mataa.base.example'].sudo().browse(example_id)
...
#         new_example = request.env['mataa.base.example'].sudo().create({
#             'name': data.get('name'),
