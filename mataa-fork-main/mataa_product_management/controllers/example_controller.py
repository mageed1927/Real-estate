...
#         limit = page_size
#         examples = request.env['mataa.product_management.example'].sudo().search([], limit=limit, offset=offset)
#         total_count = request.env['mataa.product_management.example'].sudo().search_count([])
...
#         example = request.env['mataa.product_management.example'].sudo().browse(example_id)
...
#         new_example = request.env['mataa.product_management.example'].sudo().create({
#             'name': data.get('name'),
