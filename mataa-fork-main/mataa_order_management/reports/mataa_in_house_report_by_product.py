...
class MataaInHouseReportByProduct(models.Model):
    _name = "mataa.in.house.report.by.product"
    _description = "Mataa In House Report By Product"
    _auto = False
    ...
    def select(self):
        ...
        from {tables}
        {where_clause}
        group by pp.id, pt.name, pt.categ_id, pt.uom_id, pp.mataa_id, pp.default_code, pp.barcode, pt.product_brand_id
        """
        query = """
